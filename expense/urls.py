...
from . import views
from .views import  ExpenseChartView,ExpensePieView,AddExpenseView, ExpenseListView,ExpenseUpdateView, ExpenseDeleteView, CategoryListView, AddCategoryView, CategoryUpdateView, CategoryDeleteView
urlpatterns = [

    path('', views.index,name="expenses"),
    

    path('summary/',ExpenseChartView.as_view(),name='chart'),
    path('chart/',ExpensePieView.as_view(),name='chart1'),
    path('total/',views.sum_exp,name='total'),
